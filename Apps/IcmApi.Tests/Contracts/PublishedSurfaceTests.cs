    ...
    public class PublishedSurfaceTests
    {
        ...
        public void OnlyModelsRepositoriesAndServicesAreExported()
        {
            ...
            [
                ...
                "Icm.Api.Models.Case",
                "Icm.Api.Models.CaseContact",
                "Icm.Api.Models.CasePage",
                "Icm.Api.Models.CaseQuery",
                "Icm.Api.Models.CaseReadOptions",
                "Icm.Api.Models.Contact",
                "Icm.Api.Models.ContactNameMatch",
                "Icm.Api.Models.ContactPage",
                "Icm.Api.Models.ContactQuery",
                ...
                "Icm.Api.Repositories.CaseRepository",
                "Icm.Api.Repositories.ContactRepository",
                "Icm.Api.Repositories.IBusPassRepository",
                "Icm.Api.Repositories.ICaseRepository",
                "Icm.Api.Repositories.IContactRepository",
                ...
                "Icm.Api.Services.CaseService",
                "Icm.Api.Services.ContactService",
                "Icm.Api.Services.IBusPassService",
                "Icm.Api.Services.ICaseService",
                "Icm.Api.Services.IContactService",
